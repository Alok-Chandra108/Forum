						...
						<ul id="topics">
							...
							<div class="col-md-10">
								<div class="topic-content pull-right">
                                    ...
                                    <a href="<?php echo APPURL; ?>/categories/show.php?name=<?php echo $topic->category; ?>"><!--Category that is being fetched--><?php echo $topic->category; ?></a>  >>
										 <a href="<?php echo APPURL; ?>/users/profile.php?name=<?php echo $topic->user_name; ?>"><!--Username that is being fetched--><?php echo $topic->user_name; ?></a> >> 
