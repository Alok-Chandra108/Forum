          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo APPURL ?>/users/profile.php?name=<?php echo $_SESSION['username']; ?>">Profile</a></li>
                    <li><a href="<?php echo APPURL ?>/users/edit_users.php?id=<?php echo $_SESSION['user_id']; ?>">Edit Profile</a></li>
